...
export default defineComponent({
  ...
  setup() {
    ...
    const headerNavList = ref(HEADERNAVLIST); // Left sidebar navigation
    const signList = ref(SIGNLIST); // Right sidebar navigation
    const menuList = ref(MENULIST); // User dropdown menu items
